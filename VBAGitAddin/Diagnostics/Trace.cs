...
namespace VBAGitAddin.Diagnostics
{
    ...
    public sealed class Trace
    {
        ...
        [System.Diagnostics.Conditional("TRACE")]
        public static void TraceOperationStart(string message)
        {
            TraceInternal.TraceEvent(TraceEventType.Start, 0, message, null);
        }

        [System.Diagnostics.Conditional("TRACE")]
        public static void TraceOperationStart(string format, params object[] args)
        {
            TraceInternal.TraceEvent(TraceEventType.Start, 0, format, args);
        }
